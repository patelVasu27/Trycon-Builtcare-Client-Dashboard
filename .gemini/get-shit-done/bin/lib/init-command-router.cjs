  ...
  routeCjsCommandFamily({
    ...
    handlers: {
      "execute-phase": sdkHandler(
        ...
        args.slice(1),
        () => {
          const { validate: epValidate, tdd: epTdd } = parseNamedArgs(
            args,
            [],
            ["validate", "tdd"],
          );
      ...
      "plan-phase": sdkHandler(
        ...
        args.slice(1),
        () => {
          const { validate: ppValidate, tdd: ppTdd } = parseNamedArgs(
            args,
            [],
            ["validate", "tdd"],
          );
      ...
      quick: sdkHandler("init.quick", args.slice(2), args.slice(1), () =>
      ...
      resume: sdkHandler("init.resume", args.slice(2), args.slice(1), () =>
      ...
      todos: sdkHandler("init.todos", args.slice(2), args.slice(1), () =>
      ...
      progress: sdkHandler("init.progress", args.slice(2), args.slice(1), () =>
