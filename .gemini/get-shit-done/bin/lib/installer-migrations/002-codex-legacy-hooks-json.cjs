...
module.exports = {
  ...
  description:
    "Remove legacy Codex hooks.json GSD hook registrations after config.toml migration.",
  introducedIn: "1.50.0",
  runtimes: ["codex"],
  scopes: ["global", "local"],
  destructive: true,
  runtimeContract:
    "docs/installer-migrations.md#runtime-configuration-contract-registry Codex row",
    ...
    return [
      {
        ...
        deleteIfEmpty: true,
        reason:
          "legacy Codex hooks.json GSD registration retired by installer migration",
        ownershipEvidence:
