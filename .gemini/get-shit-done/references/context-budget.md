...
The keys live in `.claude/settings.json` (project) or `C:/Users/tbc21/antigravity/TRYCON-BUILTCARE-Client-Dashboard/.gemini/settings.json` (global) — **not** in `.planning/config.json`:
