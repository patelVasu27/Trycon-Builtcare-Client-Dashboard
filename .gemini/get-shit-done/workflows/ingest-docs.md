...
```bash
INIT=$(node "C:/Users/tbc21/antigravity/TRYCON-BUILTCARE-Client-Dashboard/.gemini/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/tbc21/antigravity/TRYCON-BUILTCARE-Client-Dashboard/.gemini/get-shit-done/bin/gsd-tools.cjs" commit \
